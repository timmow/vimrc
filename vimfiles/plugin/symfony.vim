...
function! ImAmInAModule() 
  if (matchstr(expand('%:p'), '\(apps|plugins\)\(/\|\\\).\{-}\(/\|\\\)modules\(/\|\\\).\{-}\(/\|\\\)') != '')
    return 1
  else 
    return ''
  endif
...
function! ImAmInAnAction() 
  if (matchstr(expand('%:p'), '\(apps|plugins\)\(/\|\\\).\{-}\(/\|\\\)modules\(/\|\\\).\{-}\(/\|\\\)actions\(/\|\\\)actions.class.php') != '')
    return 1
  else 
    return ''
  endif
...
function! ImAmInAComponent() 
  if (matchstr(expand('%:p'), '\(apps|plugins\)\(/\|\\\).\{-}\(/\|\\\)modules\(/\|\\\).\{-}\(/\|\\\)actions\(/\|\\\)components.class.php') != '')
    return 1
  else 
    return ''
  endif
...
function! ImAmInAComponentTemplate()
  if (matchstr(expand('%:p'), '\(apps|plugins\)\(/\|\\\).\{-}\(/\|\\\)modules\(/\|\\\).\{-}\(/\|\\\)templates\(/\|\\\)_.\{-}.php') != '')
    return 1
  else 
    return ''
  endif
